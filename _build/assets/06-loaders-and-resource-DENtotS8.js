...
`,i=new URL(`06-use-loader-DDL0dAkx.js`,import.meta.url).href,a=`import * as THREE from "three"
import { Suspense } from "solid-js"
...
`,o=new URL(`06-resource-COOAEpLN.js`,import.meta.url).href,s=[{title:`Loaders & Resource`,href:`#loaders--resource`,children:[{title:`useLoader: the hook`,href:`#useloader-the-hook`,children:[]},{title:`Resource: the component`,href:`#resource-the-component`,children:[]}]}],c={title:`Loaders & Resource`};function l(t){let s={a:`a`,code:`code`,em:`em`,h1:`h1`,h2:`h2`,li:`li`,p:`p`,strong:`strong`,ul:`ul`,...n(),...t.components},{Demo:c}=s;return c||d(`Demo`,!0),[e(s.h1,{id:`loaders--resource`,get children(){return e(s.a,{"data-auto-heading":``,href:`#loaders--resource`,children:`Loaders & Resource`})}}),`
