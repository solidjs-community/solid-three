...
`,i=new URL(`08-tetris-1-render-CBQf181J.js`,import.meta.url).href,a=`import * as THREE from "three"
...
`,o=new URL(`08-tetris-2-fall-C2Quijww.js`,import.meta.url).href,s=`import * as THREE from "three"
import {
  Index,
  Show,
  batch,
...
`,c=new URL(`08-tetris-3-lines-CGsOeab5.js`,import.meta.url).href,l=[{title:`Let's build Tetris`,href:`#lets-build-tetris`,children:[{title:`Stage 1 — Two stores, some JSX`,href:`#stage-1--two-stores-some-jsx`,children:[]},{title:`Stage 2 — Gravity and keys`,href:`#stage-2--gravity-and-keys`,children:[]},{title:`Stage 3 — Lines and score`,href:`#stage-3--lines-and-score`,children:[]},{title:`The takeaway`,href:`#the-takeaway`,children:[]}]}],u={title:`Let's build Tetris`};function d(t){let l={a:`a`,code:`code`,h1:`h1`,h2:`h2`,li:`li`,p:`p`,strong:`strong`,ul:`ul`,...n(),...t.components},{Demo:u}=l;return u||p(`Demo`,!0),[e(l.h1,{id:`lets-build-tetris`,get children(){return e(l.a,{"data-auto-heading":``,href:`#lets-build-tetris`,children:`Let's build Tetris`})}}),`
...
`,e(l.p,{children:`If you'd like a peek at where the library is heading next, the encore is
WebGPU.`})]}function f(r={}){let{wrapper:i}={...n(),...r.components};return i?e(i,t(r,{get children(){return e(d,r)}})):d(r)}function p(e,t){throw Error(`Expected `+(t?`component`:`object`)+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}var m={frontmatter:u===void 0?{}:u??{},toc:l===void 0?void 0:l,editLink:``,lastUpdated:1780083166e3};typeof window<`u`&&(window.$$SolidBase_page_data??={},window.$$SolidBase_page_data[`/home/runner/work/solid-three/solid-three/site/src/routes/tour/08-tetris.mdx`]=m);var h=m;export{h as $$SolidBase_page_data,f as default,u as frontmatter};