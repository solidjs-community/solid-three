...
suggest.`]}})]}function u(r={}){let{wrapper:i}={...n(),...r.components};return i?e(i,t(r,{get children(){return e(l,r)}})):l(r)}function d(e,t){throw Error(`Expected `+(t?`component`:`object`)+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}var f={frontmatter:c===void 0?{}:c??{},toc:s===void 0?void 0:s,editLink:``,lastUpdated:178008368e4};typeof window<`u`&&(window.$$SolidBase_page_data??={},window.$$SolidBase_page_data[`/home/runner/work/solid-three/solid-three/site/src/routes/tour/06-loaders-and-resource.mdx`]=f);var p=f;export{p as $$SolidBase_page_data,u as default,c as frontmatter};