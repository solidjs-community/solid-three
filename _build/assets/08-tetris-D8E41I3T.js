...
`,i=new URL(`08-tetris-1-render-n9ZUuAMX.js`,import.meta.url).href,a=`import * as THREE from "three"
...
`,o=new URL(`08-tetris-2-fall-CDtkG7Xk.js`,import.meta.url).href,s=`import * as THREE from "three"
import {
  Index,
  Show,
  batch,
...
`,c=new URL(`08-tetris-3-lines-HbGaNqmu.js`,import.meta.url).href,l=[{title:`Let's build Tetris`,href:`#lets-build-tetris`,children:[{title:`Stage 1 — Two stores, some JSX`,href:`#stage-1--two-stores-some-jsx`,children:[]},{title:`Stage 2 — Gravity and keys`,href:`#stage-2--gravity-and-keys`,children:[]},{title:`Stage 3 — Lines and score`,href:`#stage-3--lines-and-score`,children:[]},{title:`The takeaway`,href:`#the-takeaway`,children:[]}]}],u={title:`Let's build Tetris`};function d(t){let l={a:`a`,code:`code`,h1:`h1`,h2:`h2`,li:`li`,p:`p`,strong:`strong`,ul:`ul`,...n(),...t.components},{Demo:u}=l;return u||p(`Demo`,!0),[e(l.h1,{id:`lets-build-tetris`,get children(){return e(l.a,{"data-auto-heading":``,href:`#lets-build-tetris`,children:`Let's build Tetris`})}}),`
