...
`,i=new URL(`04-click-CUi_k-kD.js`,import.meta.url).href,a=`import * as THREE from "three"
import { createSignal } from "solid-js"
import { Canvas, createT } from "solid-three"
...
`,o=new URL(`04-hover-CMaZadDG.js`,import.meta.url).href,s=`import * as THREE from "three"
import { createSignal } from "solid-js"
import { Canvas, createT } from "solid-three"
...
`,c=new URL(`04-click-missed-CSaXUHxs.js`,import.meta.url).href,l=`import * as THREE from "three"
import { createSignal } from "solid-js"
import { Canvas, createT } from "solid-three"
...
`,u=new URL(`04-stop-propagation-pKwf8yKx.js`,import.meta.url).href,d=`import * as THREE from "three"
import { createSignal } from "solid-js"
...
`,f=new URL(`04-drag-CVtNyoUS.js`,import.meta.url).href,p=[{title:`Pointer events`,href:`#pointer-events`,children:[{title:`Hover`,href:`#hover`,children:[]},{title:`Clicking nothing`,href:`#clicking-nothing`,children:[]},{title:`Stopping events`,href:`#stopping-events`,children:[]},{title:`When you actually want the full list`,href:`#when-you-actually-want-the-full-list`,children:[]},{title:`Dragging`,href:`#dragging`,children:[]}]}],m={title:`Pointer events`};function h(t){let p={a:`a`,button:`button`,code:`code`,div:`div`,em:`em`,figcaption:`figcaption`,figure:`figure`,h1:`h1`,h2:`h2`,p:`p`,pre:`pre`,script:`script`,span:`span`,style:`style`,...n(),...t.components},{Demo:m}=p;return m||_(`Demo`,!0),[e(p.h1,{id:`pointer-events`,get children(){return e(p.a,{"data-auto-heading":``,href:`#pointer-events`,children:`Pointer events`})}}),`
`,e(p.p,{get children(){return[`The button you wrote in the last chapter handled an `,e(p.code,{children:`onClick`}),` from the DOM.
`,e(p.code,{children:`solid-three`}),` lets you put the same handler on a `,e(p.code,{children:`<T.Mesh>`}),` — and gives it
the right semantics for a 3D world: it only fires when the click actually
hits that mesh.`]}}),`
`,e(m,{code:r,url:i}),`
`,e(p.p,{children:`Click the cube. Same toggle as before — just the target moved into the
scene.`}),`
`,e(p.p,{get children(){return[`Under the hood, `,e(p.code,{children:`solid-three`}),` runs a `,e(p.code,{children:`Raycaster`}),` against the pointer's
...
`,e(p.p,{get children(){return[e(p.code,{children:`setPointerCapture()`}),` solves it. Call it from `,e(p.code,{children:`onPointerDown`}),` and that
pointer is `,e(p.em,{children:`captured`}),`: every following `,e(p.code,{children:`onPointerMove`}),` and `,e(p.code,{children:`onPointerUp`}),`
goes to this mesh — on the ray or off it — until you let go.`]}}),`
`,e(m,{code:d,url:f}),`
`,e(p.p,{get children(){return[`Grab the cube and drag. It follows the pointer, and keeps following even
when the pointer races ahead of it or leaves the canvas. On `,e(p.code,{children:`pointerup`}),`
the capture releases on its own.`]}}),`
`,e(p.p,{get children(){return[`One detail makes it feel right: the `,e(p.code,{children:`event.stopPropagation()`}),` in
`,e(p.code,{children:`onPointerDown`}),` keeps the press from also grabbing meshes stacked behind the
cube — you grab the front one, not the whole column.`]}}),`
`,e(p.p,{children:`So far every trigger has been a one-off — a click, a hover-in, a
hover-out. The next chapter introduces the third kind: time.`})]}function g(r={}){let{wrapper:i}={...n(),...r.components};return i?e(i,t(r,{get children(){return e(h,r)}})):h(r)}function _(e,t){throw Error(`Expected `+(t?`component`:`object`)+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}var v={frontmatter:m===void 0?{}:m??{},toc:p===void 0?void 0:p,editLink:``,lastUpdated:178079489e4};typeof window<`u`&&(window.$$SolidBase_page_data??={},window.$$SolidBase_page_data[`/home/runner/work/solid-three/solid-three/site/src/routes/tour/04-pointer-events.mdx`]=v);var y=v;export{y as $$SolidBase_page_data,g as default,m as frontmatter};