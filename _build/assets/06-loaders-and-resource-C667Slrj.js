...
`,i=new URL(`06-use-loader-2jrg8Eq7.js`,import.meta.url).href,a=`import * as THREE from "three"
import { Suspense } from "solid-js"
...
`,o=new URL(`06-resource-Du2SMHS6.js`,import.meta.url).href,s=[{title:`Loaders & Resource`,href:`#loaders--resource`,children:[{title:`useLoader: the hook`,href:`#useloader-the-hook`,children:[]},{title:`Resource: the component`,href:`#resource-the-component`,children:[]}]}],c={title:`Loaders & Resource`};function l(t){let s={a:`a`,code:`code`,em:`em`,h1:`h1`,h2:`h2`,li:`li`,p:`p`,strong:`strong`,ul:`ul`,...n(),...t.components},{Demo:c}=s;return c||d(`Demo`,!0),[e(s.h1,{id:`loaders--resource`,get children(){return e(s.a,{"data-auto-heading":``,href:`#loaders--resource`,children:`Loaders & Resource`})}}),`
...
suggest.`]}})]}function u(r={}){let{wrapper:i}={...n(),...r.components};return i?e(i,t(r,{get children(){return e(l,r)}})):l(r)}function d(e,t){throw Error(`Expected `+(t?`component`:`object`)+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}var f={frontmatter:c===void 0?{}:c??{},toc:s===void 0?void 0:s,editLink:``,lastUpdated:1780083166e3};typeof window<`u`&&(window.$$SolidBase_page_data??={},window.$$SolidBase_page_data[`/home/runner/work/solid-three/solid-three/site/src/routes/tour/06-loaders-and-resource.mdx`]=f);var p=f;export{p as $$SolidBase_page_data,u as default,c as frontmatter};