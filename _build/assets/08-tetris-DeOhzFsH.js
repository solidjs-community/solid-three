...
WebGPU.`})]}function f(r={}){let{wrapper:i}={...n(),...r.components};return i?e(i,t(r,{get children(){return e(d,r)}})):d(r)}function p(e,t){throw Error(`Expected `+(t?`component`:`object`)+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}var m={frontmatter:u===void 0?{}:u??{},toc:l===void 0?void 0:l,editLink:``,lastUpdated:178008368e4};typeof window<`u`&&(window.$$SolidBase_page_data??={},window.$$SolidBase_page_data[`/home/runner/work/solid-three/solid-three/site/src/routes/tour/08-tetris.mdx`]=m);var h=m;export{h as $$SolidBase_page_data,f as default,u as frontmatter};