...
`LoaderCache` is the default cache for [`useLoader`](/reference/hooks/use-loader). It implements the [`LoaderRegistry`](/reference/hooks/use-loader#custom-cache) interface and adds reference counting and disposal helpers on top.
...
- [`useLoader`](/reference/hooks/use-loader) — the hook this cache backs, and how to swap it via `cache`.
