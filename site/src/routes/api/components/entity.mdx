...
These patterns automatically trigger `needsUpdate` flags on materials and geometries when necessary. See also the [chapter on smart props](/tutorial/03-smart-props).
