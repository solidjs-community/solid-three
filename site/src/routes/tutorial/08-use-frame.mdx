...
import useFrameSignal from "../../snippets/08-use-frame-signal.tsx?raw"
import useFrameImperative from "../../snippets/08-use-frame-imperative.tsx?raw"
import useFrameOptions from "../../snippets/08-use-frame-options.tsx?raw"
...
The first argument to your callback is the same scene context you'll meet
in the next chapter — `gl`, `scene`, `camera`, `clock`, `size`. Useful when
your animation depends on more than just elapsed time.
