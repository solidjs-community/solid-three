...
Any prop can be a signal. Pass one and the scene tracks it the same way
any other Solid view would — no remount, no manual diffing, no special
bindings.
...
of what you hand it: arrays, single numbers, hex codes, CSS colours all
