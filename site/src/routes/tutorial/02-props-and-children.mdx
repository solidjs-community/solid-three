...
That's the through-line. The rest of this chapter is just *what props
you can pass*.
...
*arrangement* to move, not just the individual shapes. Almost every
...
have. `solid-three` figures out the right call on the underlying
object.
