...
have, and `solid-three` figures out the right call on the underlying
object. The full coercion table — plus how `attach`, dashed paths like
`shadow-mapSize-width={1024}`, and refs work — lives on
