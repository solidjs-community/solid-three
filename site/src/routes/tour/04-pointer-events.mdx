...
thing. [`<Canvas>`](/reference/components/canvas) exposes `onClickMissed` for exactly that case:
...
[longer list of pointer events](/reference/events/overview)
...
The [events API reference](/reference/events/overview) has the full
