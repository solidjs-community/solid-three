...
[`useLoader(loaderClass, url)`](/reference/hooks/use-loader) returns an
...
[`LoaderCache`](/reference/utilities/loader-cache) is configurable per call
when you need different scoping.

## `Resource`: the component

The declarative version. [`<Resource loader={...} url="...">`](/reference/components/resource) does the same
...
[`useLoader`](/reference/hooks/use-loader) for the full surface.
