...
Every prop you've set so far has been just that — a _property_. `position`,
...
Some of the things you'd reach for aren't properties — they're _methods_.
...
and have it just work. But it won't: props get _assigned_, so solid-three
