        ...
        sidebar: [
          {
            ...
            items: [
              ...
              { title: "useFrame", link: "/tutorial/06-use-frame" },
              { title: "Loaders & Resource", link: "/tutorial/07-loaders-and-resource" },
              { title: "Custom components", link: "/tutorial/08-custom-components" },
              { title: "A small game", link: "/tutorial/09-interactive-scene" },
              { title: "A peek at WebGPU", link: "/tutorial/10-webgpu-peek" },
            ],
          },
          {
            title: "API reference",
