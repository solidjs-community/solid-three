        ...
        sidebar: [
          {
            ...
            items: [
              ...
              { title: "Portal", link: "/tutorial/11-portal" },
              { title: "Custom components", link: "/tutorial/12-custom-components" },
              { title: "An interactive scene", link: "/tutorial/13-interactive-scene" },
              { title: "A peek at WebGPU", link: "/tutorial/14-webgpu-peek" },
            ],
          },
          {
            title: "API reference",
