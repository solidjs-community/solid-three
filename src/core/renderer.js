...
import { prepare, applyProps, updateInstance, invalidateInstance, attach, detach, applyProp, } from "./utils";
...
function createThreeRenderer(roots, getEventPriority) {
    function createInstance(type, _a, root) {
        var { args = [], attach } = _a, props = __rest(_a, ["args", "attach"]);
    ...
    function removeChild(parentInstance, child, dispose) {
        ...
        if (child) {
            ...
            if ((_a = parentInstance.__r3f) === null || _a === void 0 ? void 0 : _a.objects)
            ...
            if (child.__r3f.attach) {
                ...
                if ((_b = child.__r3f) === null || _b === void 0 ? void 0 : _b.root) {
            ...
            const isPrimitive = (_c = child.__r3f) === null || _c === void 0 ? void 0 : _c.primitive;
            const shouldDispose = dispose === undefined
                ? child.dispose !== null && !isPrimitive
                : dispose;
            // Remove nested child objects. Primitives should not have objects and children that are
            // attached to them declaratively ...
            if (!isPrimitive) {
                removeRecursive((_d = child.__r3f) === null || _d === void 0 ? void 0 : _d.objects, child, shouldDispose);
    ...
    function switchInstance(instance, type, newProps) {
        var _a;
        const parent = (_a = instance.__r3f) === null || _a === void 0 ? void 0 : _a.parent;
        if (!parent)
            return;
